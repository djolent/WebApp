...
{
    public class AnalysisQueryEntity : TableEntity
    {
        public AnalysisQueryEntity(Guid analysisId, string queryId)
        {
            PartitionKey = analysisId.ToString();
            RowKey = queryId;
            CreationTime = DateTime.UtcNow;
        }

        public AnalysisQueryEntity()
        { }
